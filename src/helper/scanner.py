...
class EventScanner:
    ...
    def get_block_timestamp(self, block_num) -> datetime:
    ...
    def scan_chunk(self, start_block, end_block) -> Tuple[int, datetime.datetime, list]:
        ...
        for event_type in self.events:
            ...
            for evt in events:
                ...
                logger.debug("Processing event %s, block:%d count:%d", evt["event"], evt["blockNumber"], block_number)
    ...
    def scan(self, start_block, end_block, start_chunk_size=20, progress_callback=Optional[Callable]) -> Tuple[
        ...
        # Rescan 10 block
        self.state.end_chunk(end_block - 10)
